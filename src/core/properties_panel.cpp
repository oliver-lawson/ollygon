...
void PropertiesPanel::add_vec3_row(const QString& label, Vec3& vec, float min_val, float max_val, float speed, QGridLayout* grid, int row) {
    ...
    DragSpinBox* x_box = new DragSpinBox();
    ...
    grid->addWidget(x_box, row, 1);

    DragSpinBox* y_box = new DragSpinBox();
    ...
    grid->addWidget(y_box, row, 2);

    DragSpinBox* z_box = new DragSpinBox();
...
void PropertiesPanel::add_colour_row(const QString& label, Colour& colour, float min_val, float max_val, float speed, QGridLayout* grid, int row) {
    ...
    DragSpinBox* r_box = new DragSpinBox();
    ...
    grid->addWidget(r_box, row, 1);

    DragSpinBox* g_box = new DragSpinBox();
    ...
    grid->addWidget(g_box, row, 2);

    DragSpinBox* b_box = new DragSpinBox();
